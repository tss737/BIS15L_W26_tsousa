...
gabon %>% 
  ...
  labs(title="Number of Transects Per Land Use Type",
       x="Land Use",
...
gabon %>% 
  ...
  labs(title="Vegetation Richness of Land Use Types",
       x="Land Use Type",
...
gabon %>% 
  ...
  geom_boxplot(mapping=aes(fill=land_use))+
  labs(title="All Species Diversity of Land Use Types",
       x="Land Use Type",
       y="All Species Diversity")
```

The average all species diversity was the highest fopr the park land use type.
