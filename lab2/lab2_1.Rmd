...
```{r}
mean(c(2, 8, 2)) #c stands for concat/combine and creates a vector
```
...
```{r}
new_vector <- c(7, 6.2, 5, 9, NA, 4, 9.8, 7, 3, 2) #creates a new vector
```
...
You can not calc the mean if the vector contains an NA
