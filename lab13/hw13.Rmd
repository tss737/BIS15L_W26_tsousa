...
Subspecies, female body mass at maturity, and female svl at maturity have the most missing values.
...
This does make sense biologically. Mammals should have 100% NA for egg mass because mammals do not lay eggs (lets pretend platypus don't exist). Reptiles to lay eggs, and so do avians, so we can assume the NA's in those ones are due to sampling difficulties.
