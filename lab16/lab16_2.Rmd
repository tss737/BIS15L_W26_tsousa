...
```{}
mv UKWF56GV016-Alignment-Descriptions.csv genome01_blastn.csv
mv genome01_blastn.csv BIS15L_W26_tsousa/lab16/data/blast_results
```
...
Which hit had the highest e-value?**(include the description, e_value, and link to the accession number for this hit)**
```{r}
genome01_blastn %>% 
...
```{}
mv blastp_results.csv BIS15L_W26_tsousa/lab16/data/blast_results/
ls BIS15L_W26_tsousa/lab16/data/blast_results/
```
